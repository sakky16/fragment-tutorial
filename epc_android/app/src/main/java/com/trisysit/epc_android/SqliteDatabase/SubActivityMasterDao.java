...
/** 
 * DAO for table "SUB_ACTIVITY_MASTER".
*/
public class SubActivityMasterDao extends AbstractDao<SubActivityMaster, Void> {

    public static final String TABLENAME = "SUB_ACTIVITY_MASTER";

    /**
     * Properties of entity SubActivityMaster.<br/>
    ...
    public SubActivityMasterDao(DaoConfig config) {
        super(config);
    }
    
    public SubActivityMasterDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SUB_ACTIVITY_MASTER\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SUB_ACTIVITY_MASTER\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SubActivityMaster entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SubActivityMaster entity) {
        stmt.clearBindings();
    ...
    @Override
    public SubActivityMaster readEntity(Cursor cursor, int offset) {
        SubActivityMaster entity = new SubActivityMaster( //
    ...
    @Override
    public void readEntity(Cursor cursor, SubActivityMaster entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(SubActivityMaster entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(SubActivityMaster entity) {
        return null;
    }

    @Override
    public boolean hasKey(SubActivityMaster entity) {
        // TODO
        return false;
    }
